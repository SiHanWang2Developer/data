...
#errorlabelme2coco.py: error: the following arguments are required: labelme_images
#python errorlabelme2coco.py images
#python errorlabelme2coco.py  cocoData\pic
